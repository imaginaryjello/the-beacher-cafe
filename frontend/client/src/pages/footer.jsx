  ...
  return (
    <footer className="bg-[#3f2a1d] text-[#f5e8c7] mt-16">
      <div className="max-w-6xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-3">
        ...
        {/* Contact + Hours — now dynamic from settings */}
        <div>
          ...
          <p className="text-sm mb-2">
            {settings?.address || "2164 Queen St E, Toronto, ON"}
          </p>
          <p className="text-sm mb-4">
            {settings?.phone || "+1 (647) 123-4567"}
          </p>
        ...
        <div>
          ...
          <div className="flex gap-2 -ml-2">
            <a href="#!" className="hover:scale-110 transition p-2">
